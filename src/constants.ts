...
export const TRANSLATIONS = {
  it: {
    ...
    clearLocalDataDescription: 'Ripristina preferenze e filtri salvati in questo browser.',
  ...
  en: {
    ...
    clearLocalDataDescription: 'Resets preferences and filters saved in this browser.',
