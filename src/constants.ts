...
export const TRANSLATIONS = {
  it: {
    ...
    clearLocalDataDescription: 'Cancella voli locali, preferenze e filtri salvati in questo browser.',
    ...
    importProgress: 'Importazione immagini',
    imagesProcessed: 'immagini processate',
    queuedImage: 'in coda',
    processingImage: 'preparo',
    uploadingImage: 'upload',
    readingImage: 'lettura',
    completedImage: 'completata',
    failedImages: 'fallite',
  ...
  en: {
    ...
    clearLocalDataDescription: 'Clears local flights, preferences, and filters saved in this browser.',
